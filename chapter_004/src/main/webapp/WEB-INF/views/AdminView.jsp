                ...
                <nav class="navbar navbar-default" role="navigation">
                    ...
                    <div class="side-menu-container">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="${pageContext.servletContext.contextPath}/create"><span class="glyphicon glyphicon-user"></span>Create</a></li>
                            <!-- Dropdown-->
                            <li class="panel panel-default" id="dropdown">
                                ...
                                <div id="dropdown-lvl1" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <ul class="nav navbar-nav">
                                            <li><a href="#" onclick="doFilter('')"><span>show all</span></a></li>
        ...
        <table class="table table-bordered form-control" id="table">
            ...
            <c:forEach var="user" items="${requestScope.users}">
                <tr>
                    ...
                    <td>
                        <input type="button" class="form-control button btn-default" value="Delete" onclick="erase('${user.id}')">
                    </td>
                </tr>
            </c:forEach>
        </table>
